...
/// <summary>
/// Shared implementation of the Global-then-World ini override rule: reads
/// <c>Global/{fileName}</c>, then - if a world is given - merges an optional
/// <c>Worlds/{worldName}/{fileName}</c> over it, with the world file's entries taking precedence
/// for same-named keys/sections while anything only defined globally still applies. Used by both
/// <see cref="ColorPalette"/> and <see cref="MaterialLibrary"/>.
/// </summary>
